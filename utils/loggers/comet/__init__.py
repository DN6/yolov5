...
COMET_SAVE_MODEL = os.getenv("COMET_SAVE_MODEL", "true").lower() == "true"
    ...
    def __init__(
        ...
        if self.experiment is not None:
            ...
            self.experiment.log_other(
                "Run Name",
                f"{self.experiment.workspace}/{self.experiment.project_name}/{self.experiment.name}",
            )
            if run_id is None:
                self.experiment.log_parameters(vars(opt), prefix="opt")
